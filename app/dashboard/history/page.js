                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        ...
                        <div className={styles.desktopReport} style={{ overflowX: 'auto', margin: '16px 0', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                        ...
                        <div className={styles.mobileReport} style={{ overflowX: 'auto', margin: '16px 0', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
                          <table className={styles.reportTable}>
                            <thead>
